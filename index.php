...
<body>
    <header>
        <a href="login.php"><img class="login-icon" src="css/img/user-interface.png"></a>
        <div class="logo">
            <img class="logo-img" src="css/img/logo_cropped(2).png" alt="">
        </div>
        <div class="burger">
    ...
    <div class="burger-menu">
        <ul>
            ...
            <hr>
            <li><a href="massage.html">Salon de massage</a></li>
            <hr>
            <li><a href="piscine.html">Piscine</a></li>
            <hr>
            <li><a href="restaurant.html">Restauration</a></li>
            <hr>
    ...
    <main>
        ...
        <div class="container-services">
            ...
            <div class="service">
                ...
                <div class="content">
                    <p>Notre hôtel de luxe propose des chambres raffinées : Classique, Confort, Standing et Suite, pour un séjour d'exception.</p>
                    <button><a href="restaurant.html">Voir le restaurant</a></button>
                </div>
            </div>
        </div>
        <footer>
